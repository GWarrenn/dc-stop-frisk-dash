...
nbh_counts['moving_avg'] = nbh_counts.groupby('neighborhood')['counts'].apply(pd.rolling_mean, 4, min_periods=1)
...
app.layout = html.Div(children=[
    html.Div([
    	html.P('Select Neighborhood:', style={'font-family': 'Monospace','font-size':'20px'}), 
            dcc.Dropdown(
	    	id = 'nbh-filter',
	    	options=[
